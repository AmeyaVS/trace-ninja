 ...
 * @brief: Dump trace.
 */
static void trace_write(traceAttributes *tb) __attribute__((no_instrument_function));
#ifdef __cplusplus
extern "C" {
#endif // __cplusplus
/**
 ...
 * @brief: Dump trace.
 */
static void trace_write(traceAttributes *tb) {
  if(fDumpOpen == false) {
    trace_init();
  }
  fwrite(tb, sizeof(traceAttributes), 1, fDump);
};
